...
class InfosSpider(scrapy.Spider):
    ...
    def get_all_history_license(self,person_item:dict):
        ...
        if self.page.query_selector(
            ...
            if self.page.query_selector(
                '//span[contains(text(),"10")]/ancestor::td[1]/following-sibling::td//a[contains(text(),"...")]'
            ):
                self.page.click(
                    '//span[contains(text(),"10")]/ancestor::td[1]/following-sibling::td//a[contains(text(),"...")]'
                )
                self.page.wait_for_selector('//td/span[contains(text(),"11")]')
                self.get_license_history_items_from_page(person_item)
                next = self.page.query_selector(
